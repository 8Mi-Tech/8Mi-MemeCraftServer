package CumServer.server.utils;

import java.util.*;
import java.util.concurrent.ConcurrentSkipListSet;

public class CumTreeSet<E> extends TreeSet<E> {
    private ConcurrentSkipListSet<E> m;
    private static final Object PRESENT = new Object();

    CumTreeSet(ConcurrentSkipListSet<E> m) {
        this.m = m;
    }
    ...
    public CumTreeSet(Comparator<? super E> comparator) {
        this(new ConcurrentSkipListSet<>(comparator));
    }

    public CumTreeSet(Collection<? extends E> c) {
        this();
        addAll(c);
    }

    public CumTreeSet(SortedSet<E> s) {
        this(s.comparator());
        addAll(s);
    }
